...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  HAL_GPIO_WritePin ( LED_1_YELLOW_GPIO_Port , LED_1_YELLOW_Pin ,GPIO_PIN_SET );
	  HAL_GPIO_WritePin ( LED_1_GREEN_GPIO_Port , LED_1_GREEN_Pin ,GPIO_PIN_SET );
	  for(int i= 5; i> 0; i--)	  {display7SEG(i);
	  HAL_Delay(1000);
	  }
	  //
	  HAL_GPIO_WritePin ( LED_RED_GPIO_Port , LED_RED_Pin ,GPIO_PIN_SET );
	  ...
	  HAL_GPIO_WritePin ( LED_1_YELLOW_GPIO_Port , LED_1_YELLOW_Pin ,GPIO_PIN_RESET );
	  HAL_GPIO_WritePin ( LED_1_GREEN_GPIO_Port , LED_1_GREEN_Pin ,GPIO_PIN_SET );
	  for(int i= 2; i> 0; i--)	  {display7SEG(i);
	  HAL_Delay(1000);
	  }
    /* USER CODE END WHILE */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_1_RED_Pin|LED_1_YELLOW_Pin|LED_1_GREEN_Pin|LED_RED_Pin
                          |LED_YELLOW_Pin|LED_GREEN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, seg_a_Pin|seg_b_Pin|seg_c_Pin|seg_d_Pin
                          |seg_e_Pin|seg_g_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_1_RED_Pin LED_1_YELLOW_Pin LED_1_GREEN_Pin LED_RED_Pin
                           LED_YELLOW_Pin LED_GREEN_Pin */
  GPIO_InitStruct.Pin = LED_1_RED_Pin|LED_1_YELLOW_Pin|LED_1_GREEN_Pin|LED_RED_Pin
                          |LED_YELLOW_Pin|LED_GREEN_Pin;
